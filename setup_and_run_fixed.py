#!/usr/bin/env python3
"""
Setup and run script for Raspberry Pi Day Planner (Fixed)
"""
...
def main():
    ...
    if not os.path.exists("dayplanner_env"):
        ...
        if not run_command("python3 -m venv dayplanner_env", "Creating virtual environment", shell=False):
            return False
    else:
